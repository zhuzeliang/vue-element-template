  ...
  <div class="editor">
    <div class="top-container">
      <div ref="toolbar" class="toolbar">
        ...
        <i data-command="redo" class="command iconfont icon-redo disable" title="重做" />
        <span class="separator" />
        <i data-command="copy" class="command iconfont icon-copy-o" title="复制" />
        <i data-command="paste" class="command iconfont icon-paster-o disable" title="粘贴" />
    ...
    <div class="bottom-container">
      <div class="left-pannel">
        <div ref="itempannel" class="itempannel-container">
          <img
            draggable="false"
      ...
      <div class="center-pannel">
        ...
        <div ref="contextmenu" class="contextmenu" style="position: absolute; z-index: 2;">
      ...
      <div class="right-pannel">
          ...
          <div ref="detailpannel">
            <div data-status="node-selected" class="pannel" style="display: none;">
              ...
              <div class="block-container">
                <div class="p name">
                  名称：
                  <el-input v-model="nodeName" size="mini" />
                </div>
                <div class="p name">
                  名称：
                  <el-input v-model="nodeContent" size="mini" />
                </div>
                <div class="p name">
                  节选自：
                  <el-select v-model="nodeFrom" size="mini">
                ...
                <div class="p name">
                  关联文件：
                  <el-select v-model="nodeFile" size="mini">
                    <el-option label="区域一" value="shanghai" />
                    <el-option label="区域二" value="beijing" />
                  </el-select>
                </div>
                <div class="p size">
                  尺寸：
                  <el-input v-model="nodeWidth" size="mini" />
                  <el-input v-model="nodeHeight" size="mini" />
                </div>
                <div class="p color">
                  颜色：
                  <el-color-picker v-model="nodeColor" size="mini" />
                </div>
              </div>
            </div>
            <div
            ...
            >
              ...
              <div class="block-container">
                <div class="p name">
                  名称：
                  <el-input v-model="edgeName" size="mini" />
                </div>
              </div>
            </div>
            <div
            ...
            >
              ...
              <div class="block-container">
                <div class="p name">
                  名称：
                  <el-input v-model="groupName" size="mini" />
                </div>
                <div class="p color">
                  颜色：
                  <el-color-picker v-model="groupColor" size="mini" />
                </div>
              </div>
            </div>
            <div
            ...
            >
              ...
              <div class="block-container">
                <div class="p color">
                  颜色：
                  <el-color-picker v-model="multiColor" size="mini" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="navigator">
          ...
          <div ref="minimap" class="mini-map" />
        </div>
        ...
        switch (ev.item.type) {
          case 'node':
            if (!this.isMultiSelect) {
              ...
              this.nodeContent = ev.item.model.content
              this.nodeFrom = ev.item.model.from
              this.nodeFile = ev.item.model.file;
